...
test("travelops: test kiali dashboard and travel-agency graph", async ({
  page,
}) => {
  ...
  await page
    .locator('[data-test="travel-agency-EXPAND"]')
    .getByRole("img", { name: "left" })
    .click();
  await page
    .locator('[data-test="travel-control-EXPAND"]')
    .getByRole("img", { name: "left" })
    .click();
  await page
    .locator('[data-test="travel-portal-EXPAND"]')
    .getByRole("img", { name: "left" })
    .click();
  ...
  await page
    .locator('[id="namespace-list-item\\[travel-agency\\]"]')
    .getByRole("checkbox")
    .check();
  await page
    .locator('[id="namespace-list-item\\[travel-agency\\]"]')
